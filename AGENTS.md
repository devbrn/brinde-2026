...
See `.claude/CLAUDE.md` for global development rules (Stack, Tailwind v4, Restrictions).

See `ARCHITECTURE.md` for project-specific details, DB schema, and RAG implementation.

See `TASKS.md` for tasks