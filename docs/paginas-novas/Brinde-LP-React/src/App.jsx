...
function AwardVideo() {
  ...
  return (
    <div className={`reel-frame reveal${inlinePlayer ? ' inline-player' : ''}`}>
      <video
        ref={videoRef}
        src="/assets/prova-social.mp4"
        poster="/assets/prova-social-poster.jpg"
        preload="metadata"
        playsInline
  ...
  return (
    <footer>
      <div className="wrap foot">
        <img src="/assets/brinde-azul.png" alt="Brinde Marketing e Publicidade" />
