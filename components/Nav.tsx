  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-black text-white px-6 py-4 flex items-center justify-between">
      ...
      <div className="hidden md:flex items-center gap-8 ml-auto" style={{ fontFamily: 'var(--font-poppins), sans-serif', fontWeight: 700 }}>
        ...
        <a href="https://instagram.com/agenciabrinde" target="_blank" rel="noopener noreferrer" className="text-white hover:text-white/70 transition" aria-label="Instagram">
        ...
        <a href="https://linkedin.com/company/agenciabrinde" target="_blank" rel="noopener noreferrer" className="text-white hover:text-white/70 transition" aria-label="LinkedIn">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
