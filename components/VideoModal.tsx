      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed inset-0 bg-[#050a30]/80 z-50 flex items-center justify-center p-4"
          >
            <motion.div
              ...
              className="relative w-full max-w-4xl aspect-video bg-[#050a30] rounded-lg overflow-hidden"
            >
              <video
                src={videoUrl}
                muted={isMuted}
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                onClick={() => setIsOpen(false)}
                className="absolute top-4 right-4 bg-[#050a30]/60 hover:bg-[#050a30]/80 p-2 rounded-full text-white transition-all text-2xl"
              >
                ✕
              </motion.button>
